        ...
        <div className="fade-in-element opacity-0 translate-y-8 transition-all duration-1000 ease-out text-center p-8 md:p-10 rounded-3xl border border-white/20 bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/15%),theme(backgroundColor.white/5%))]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            href="/contact"
             ...
             className="group inline-flex items-center gap-3 px-8 py-3 md:px-8 md:py-4 bg-linear-to-r from-white to-slate-100 text-slate-900 rounded-full font-semibold text-base md:text-lg hover:from-slate-50 hover:to-slate-200 transition-all duration-300 hover:scale-105 shadow-2xl">
              Book a Call{" "}
