    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-light text-white">Edit Opening</h1>
                    <p className="text-white/40 text-sm">Update job details</p>
                </div>
            </div>

            <form onSubmit={handleSubmit} className="space-y-8">
                {/* Same fields as New Career Page - duplicated for explicit control */}
                {/* Basic Info */}
