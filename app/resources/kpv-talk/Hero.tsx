    ...
    <section className="flex items-start justify-center px-4 pt-24 md:pt-32 p-8 relative">
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-sm font-medium mb-8 mt-8 md:mt-12 animate-fade-in-badge">
          <span className="w-2 h-2 bg-indigo-300/60 rounded-full mr-2 animate-pulse"></span>
          KPV Talk
        </div>
        <div className="space-y-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight text-balance animate-fade-in-heading">
            ...
            Conversations on Tech, Leadership & Building Great Products
          </h1>
          ...
          <div className="animate-fade-in-subheading">
            ...
            KPV Talk is a podcast about technology, leadership, and product strategy. Host Simon Schifferle sits down with founders, engineers, and executives to explore how teams build great products, scale businesses, and navigate emerging trends in tech and finance. Expect practical insights, candid stories, and actionable takeaways for practitioners and leaders alike.
              </span>
            </div>
          </div>
        </div>{" "}
